...
var loader_timeline = gsap.timeline();
loader_timeline.to(".loader",{scale:1,opacity:1,visibility: 'visible'}),
loader_timeline.fromTo(".loader .center .dot1",{opacity:0,duration:1,repeat:-1,ease: Power0.easeNone},{opacity:1,duration:1,repeat:-1,ease: Power0.easeNone},0),
loader_timeline.fromTo(".loader .center .dot2",{opacity:0,duration:1,repeat:-1,ease: Power0.easeNone},{opacity:1,duration:1,repeat:-1,ease: Power0.easeNone},0),
loader_timeline.fromTo(".loader .center .dot3",{opacity:0,duration:1,repeat:-1,ease: Power0.easeNone},{opacity:1,duration:1,repeat:-1,ease: Power0.easeNone},0),
loader_timeline.to(".loader .circle", { rotate: 360, duration: 8,repeat: -1, ease: Power0.easeNone },0);
