...
"pageview"!=ASP.analytics.method)return!1;if(""!=ASP.analytics.string){var c="function"==typeof __gaTracker?__gaTracker:"function"==typeof ga?ga:!1,f="function"==typeof gtag?gtag:!1;p.location.origin||(p.location.origin=p.location.protocol+"//"+p.location.hostname+(p.location.port?":"+p.location.port:""));var g=this.o.homeurl.replace(p.location.origin,"");!1!==f?!1!==d&&f("config",d,{page_path:g+ASP.analytics.string.replace("{asp_term}",a)}):!1!==c&&(!1!==d&&c("create",d,"auto"),c("send","pageview",
{page:g+ASP.analytics.string.replace("{asp_term}",a),title:"Ajax Search"}))}},gaEvent:function(a,d){var c=this.gaGetTrackingID();if("undefined"==typeof ASP.analytics||"event"!=ASP.analytics.method)return!1;var f="function"==typeof gtag?gtag:!1,g="function"==typeof __gaTracker?__gaTracker:"function"==typeof ga?ga:!1;if(!1===f&&!1===g)return!1;if("undefined"!=typeof ASP.analytics.event[a]&&1==ASP.analytics.event[a].active){var e={search_id:this.o.id,search_name:this.o.name,phrase:this.n.text.val(),
option_name:"",option_value:"",result_title:"",result_url:"",results_count:""},l={event_category:ASP.analytics.event[a].category,event_label:ASP.analytics.event[a].label,value:ASP.analytics.event[a].value};d=b.extend(e,d);b.each(d,function(h,k){k=String(k).replace(/[\s\n\r]+/g," ").trim();b.each(l,function(n,r){l[n]=r.replace(new RegExp("{"+h+"}","gmi"),k)})});!1===f?(!1!==c&&g("create",c,"auto"),g("send","event",l.event_category,ASP.analytics.event[a].action,l.event_label,l.value)):(!1!==c&&(l.send_to=
